						...
						<table class="table table-striped ">
							...
							%>
								...
								<tr>
									...
									<td><%=c.getPrice() %></td>
									<td>
									<a href="remove_book?bid=<%=c.getBid() %>&&uid=<%=c.getUserId() %>&&cid=<%=c.getCid()%>" class="btn btn-sm btn-danger">Remove</a></td>
									</tr>
								<%
								}
							%>
				...
				<div class="card">
					<div class="card-body">
						...
						<input type="hidden" value="${userobj.id }" name="id">
							...
							<select class="form-group" name="payment" required>
